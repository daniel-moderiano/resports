...
export const useGetTwitchVideos = (userId: string, videoType: HelixVideoType | 'all' = 'archive', conditions?: boolean) => {

  const { isLoading, isError, data, error, refetch } = useQuery(['twitchChannelVideos', userId, videoType], async () => {
