...
const ForwardFiveIcon = ({ iconStyles, fill }: ForwardFiveIconProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={iconStyles} fill={fill} viewBox="0 0 24 24" enableBackground="new 0 0 24 24">
