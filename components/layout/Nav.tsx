  ...
  return (
    <nav role="navigation" className="nav">
      <ul role="menubar" className={styles.navList}>
        <li role="menuitem" className={styles.navListItem}>Home</li>
        <li role="menuitem" className={styles.navListItem}>Sign up</li>
        <li role="menuitem" className={styles.navListItem}>Log in</li>
        <li role="menuitem" className={styles.navListItem}>Log out</li>
      </ul>
    </nav>
  )
}
